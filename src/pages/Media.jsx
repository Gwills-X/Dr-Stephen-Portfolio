...
const articles = [
  { title: "The Power of Knowledge", link: "https://tesselledevelopment.com/research-lives-and-cultures/stephenaderinto" },
...
const videos = [
  { title: "Leadership Talk", link: "https://www.youtube.com/shorts/4v6hmmqAEV4" }, // Replace with actual links
  { title: "Scholarship Guidance", link: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
];
      ...
      <section className="max-w-6xl mx-auto mb-32">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {gallery.map((item, i) => (
            <motion.div
              key={i}
              onClick={() => setModal({ open: true, image: item.image, title: item.title })}
      ...
      {modal.open && (
        ...
        >
          <div className="relative max-w-3xl w-full">
            <img src={modal.image} alt={modal.title} className="w-full rounded-xl shadow-2xl" />
