...
const testimonials = [
  { name: "Chidera Okafor", role: "Scholarship Recipient", text: "Dr. Stephen’s mentorship completely transformed my approach to research and leadership. I achieved my scholarship goal and grew in discipline and faith." },
  { name: "Emeka Nwosu", role: "Research Fellow", text: "The guidance I received under Dr. Stephen’s programs was life-changing. I learned how to structure my research, communicate effectively, and lead with integrity." },
  { name: "Ngozi Uche", role: "Student Leader", text: "Through his mentorship, I not only excelled academically but also developed as a leader committed to service and positive impact." },
  { name: "Tunde Alabi", role: "Entrepreneurship Mentee", text: "Dr. Stephen’s insights on entrepreneurship and innovation empowered me to start my first sustainable venture with confidence." },
];
