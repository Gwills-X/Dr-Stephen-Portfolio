      ...
      <section className='py-24'>
        <div className='max-w-4xl mx-auto bg-white p-10 rounded-2xl shadow-md space-y-6'>
          <h2 className='text-4xl max-md:text-2xl font-bold text-gray-900 mb-6 text-center'>
            Wisdom Academy Consortium Grant Initiative
          </h2>
          ...
          <p className='text-gray-700 leading-relaxed'>
            To qualify, research must lead to at least one published paper, with
            acknowledgment of Dr. Stephen Aderinto and Mrs. Channelle Aderinto.
          </p>
          ...
          <footer className='text-gray-900 font-semibold text-right'>
            — Dr. Stephen Aderinto
          </footer>
        </div>
      </section>
