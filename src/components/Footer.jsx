	...
	return (
		<footer
			className={`relative overflow-hidden ${
				isDark
					? "bg-gradient-to-r from-gray-700 via-gray-900 to-gray-700 text-gray-300"
				...
				<motion.div variants={item}>
					...
					<ul className='space-y-3'>
						{[
							...
							<li key={i}>
								<Link to={l.path} className='hover:text-blue-400 transition'>
									{l.name}
								</Link>
							</li>
						))}
				...
				<motion.div variants={item}>
					...
					<form className='flex max-w-sm mx-auto md:mx-0'>
						<input
							...
							className='w-full px-4 py-3 rounded-l-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none'
						/>
						<button
							type='button'
